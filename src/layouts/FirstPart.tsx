    ...
    <>
      ...
      <section className="mt-[31px] bg-gray pb-[62px] pt-[53px]">
        <div className="mx-[24px] max-w-[1424px] desktop:mx-auto">
          ...
          <p className="font-regular mt-[53px] max-w-[779px] text-[20px] leading-relaxed text-blue">
            {he.decode(data.acf.partie_bleu)}
          </p>
          <p className="mt-[66px] max-w-[779px] text-[20px] font-normal italic leading-relaxed text-blackGray">
